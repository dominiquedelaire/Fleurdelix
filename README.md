<img width="972" height="741" alt="fleurdelixlogo - Modifié" src="https://github.com/user-attachments/assets/a9e3bacf-3549-46b4-bd33-6d8ac18042cd" />

Système d'exploitation souverain pour l'IA et pour le québec

# Introduction
Anciennement ShellbotsOS, Fleurdelix a été réécrit de A à Z avec une base linux sans aucun logiciel. J'ai ajouté chaque module au fur et à mesure pour en faire un système d'exploitation fiable et sécuritaire en français et permettant de réaliser tous types d'opérations, notamment de l'entraînement de données, du deep learning, des agents IA, etc... tout cela avec des modèles locaux pour la sécurité de vos données personnelles et d'entreprises.
