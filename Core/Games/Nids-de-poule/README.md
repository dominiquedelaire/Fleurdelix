...
Ou si tu n'es pas patient, lance le [jeu maintenant en ligne](https://fleurdelix.quebec/execute/Nids_de_poule_MTL.html)

## 📸 Captures d'écran

| Menu principal | Vue 2D (de haut) |
|:---:|:---:|
| ![Menu principal](screenshots/vue-3d-hiver.png) | ![Vue 2D](screenshots/vue-3d-printemps.png) |

| Vue 3D ,  Printemps | Vue 3D ,  Hiver |
|:---:|:---:|
| ![Vue 3D printemps](screenshots/vue-2d.png) | ![Vue 3D hiver](screenshots/menu.png) |
...
- Ou joue en ligne directement en cliquant sur ce lien : [Nids_de_poule_MTL.html](https://fleurdelix.quebec/execute/Nids_de_poule_MTL.html)
